...
const Rules = () => (
  <div className={classes.container}>
    ...
    <p>Só poderão concorrer aos prêmios pessoas que estiveram presentes no evento. Porém isso não impede a participação de mais colegas na execução.</p>
    ...
    <p>Só poderão compor o time de execução alunos matriculados em escolas de ensino médio.</p>
