  ...
  return (
    <div>
      <h2>
        ...
        <a href="https://app.crieoimpossivel.com.br">Empower</a>
      </h2>
      <p>
      ...
      <p>
        ...
        nosso site é importante para o Empower.
      </p>
      <p>
        Todas as informações pessoais relativas a membros, assinantes, clientes
        ou visitantes que usem o Empower serão tratadas em concordância com a
      ...
      <p>
        O uso do Empower pressupõe a aceitação deste{' '}
        <a
        ...
        . A equipa do Empower reserva-se ao direito de alterar este acordo sem
      ...
      <p>
        O Empower possui ligações para outros sites, os quais, a nosso ver,
